...
<body>
	<table align='center' border='0' bgcolor='aqua' width='1250' cellpadding='8' cellspacing='0' height='200'>
...
$id=$_POST["id"];
$delete=mysqli_query("delete from registration where id='$_POST[id]'");
if($delete){
...
print "<table width='100%' bgcolor='aqua' border='0' cellpadding='3' cellspacing='2' bgcolor='silver'>
...
<br/>
          ...
          <tr>
		  <td align="center" bgcolor='aqua'><a href="officerpanel.php" target="_parent">Panel Panel <b>|</b></a>
