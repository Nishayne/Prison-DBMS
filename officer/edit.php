...
if ($error != '')
{
echo '<div style="padding:4px; border:1px solid aqua; color:aqua;">'.$error.'</div>';
}
?>
...
<tr>
<td colspan="2" align="center"><b><font color='aqua'>EDIT TRANSFER  RECORDS </font></b></td>
</tr>
...
$Nid = $_POST['Nid'];
$From = mysqli_real_escape_string(htmlspecialchars($_POST['From']));
$To = mysqli_real_escape_string(htmlspecialchars($_POST['To']));
$dateoftransfer = mysqli_real_escape_string(htmlspecialchars($_POST['dateoftransfer']));
...
// use code update db
mysqli_query("UPDATE transfer SET File_Num='$Filenum', From_prison='$From', 
...
//user the second
$result = mysqli_query("SELECT * FROM transfer WHERE id=$National_id")
or die(mysqli_error());
